...
/**
 * Swagger : GetAllReportsDocumentation.
 */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
@Operation(summary = "Get all report information",
    description = "Get all report information.",
...
public @interface GetAllReportsDocumentation {
}
